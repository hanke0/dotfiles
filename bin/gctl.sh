...
Command:
    showdelete  show all delete files in history of commit.
    deepdelete  deep delete file in total repo, incluing history of commits.
    cm          commit with messages.
    push        push to origin
    cl          clone a repository into current sub directory as it directory.
EOF
}
